...
for (let i=0; i<inventory.length; i++){
  if (inventory[i].car_make === "BMW" || inventory[i].car_make === "Audi") {BMWAndAudi.push(inventory[i].car_year+" "+inventory[i].car_make +" "+ inventory[i].car_model ); }
}  
stringBandA = JSON.stringify(BMWAndAudi);
console.log(stringBandA);
